        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link href="/services" className="hover:text-primary transition-colors duration-300">Programs</Link></li>
              <li><Link href="/membership" className="hover:text-primary transition-colors duration-300">Membership</Link></li>
              <li><Link href="/trainers" className="hover:text-primary transition-colors duration-300">Trainers</Link></li>
